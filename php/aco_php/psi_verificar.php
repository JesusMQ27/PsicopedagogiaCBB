...
if ($p_remember == "1") {
    setcookie("login_remember", "1", $cookie_expiration_time, "/");
    setcookie("login_usuario", $p_usuario, $cookie_expiration_time, "/");
    setcookie("usuario_password", $p_clave, $cookie_expiration_time, "/");
} else {
    setcookie("login_remember", "0", $cookie_expiration_time, "/");
    setcookie("login_usuario", "", $cookie_expiration_time, "/");
    setcookie("usuario_password", "", $cookie_expiration_time, "/");
}
