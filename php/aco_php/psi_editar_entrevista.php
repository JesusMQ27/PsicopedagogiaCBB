...
try {
    ...
    if ($tipo === "ent") {//entrevista
        ...
        if (strpos($s_img1, 'data:image/png;base64') === 0) {
            ...
            fnc_modificar_solicitud_sub_entrevista_firmas($conexion, $id, "1", $sol_matricula, $codigo_usuario, $s_apoderado, str_replace("./php/", "../", $s_img1), "NOW()", "1");
        }
        ...
        if (strpos($s_img2, 'data:image/png;base64') === 0) {
            ...
            fnc_modificar_solicitud_sub_entrevista_firmas($conexion, $id, "2", $sol_matricula, $codigo_usuario, $s_apoderado, str_replace("./php/", "../", $s_img2), "NOW()", "1");
        }
    }
    $str_submenu = "";
    $str_menu_id = "";
